                ...
                <div class="p-6">
                    <form method="POST" action="{{ route("tenant.clients.store") }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="cpf_cnpj" id="cpf_cnpj" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old("cpf_cnpj") }}">
                            @error("cpf_cnpj")
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="address" id="address" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old("address") }}</textarea>
                            @error("address")
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
