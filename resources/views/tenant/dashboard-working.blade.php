        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
                        ...
                        <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 p-4 rounded-lg text-white text-center">
                            <div class="text-2xl font-bold">{{ $stats['fees_count'] }}</div>
                            <div class="text-sm opacity-90">Honorários</div>
                        </div>
                        <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 p-4 rounded-lg text-white text-center">
                            <div class="text-2xl font-bold">{{ $stats['appointments_count'] }}</div>
                            <div class="text-sm opacity-90">Compromissos</div>
                        </div>
                        <div class="bg-gradient-to-br from-pink-500 to-pink-600 p-4 rounded-lg text-white text-center">
                            <div class="text-2xl font-bold">{{ $stats['deadlines_count'] }}</div>
                            <div class="text-sm opacity-90">Prazos</div>
                        </div>
                        <div class="bg-gradient-to-br from-teal-500 to-teal-600 p-4 rounded-lg text-white text-center">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div class="group bg-blue-50 hover:bg-blue-100 p-4 rounded-lg transition-colors duration-200 border border-blue-200 hover:border-blue-300">
                        ...
                        <div class="group bg-green-50 hover:bg-green-100 p-4 rounded-lg transition-colors duration-200 border border-green-200 hover:border-green-300">
                            <div class="flex items-center">
                        ...
                        <div class="group bg-purple-50 hover:bg-purple-100 p-4 rounded-lg transition-colors duration-200 border border-purple-200 hover:border-purple-300">
                            <div class="flex items-center">
                        ...
                        <div class="group bg-yellow-50 hover:bg-yellow-100 p-4 rounded-lg transition-colors duration-200 border border-yellow-200 hover:border-yellow-300">
                            <div class="flex items-center">
                        ...
                        <div class="group bg-indigo-50 hover:bg-indigo-100 p-4 rounded-lg transition-colors duration-200 border border-indigo-200 hover:border-indigo-300">
                            <div class="flex items-center">
                        ...
                        <div class="group bg-pink-50 hover:bg-pink-100 p-4 rounded-lg transition-colors duration-200 border border-pink-200 hover:border-pink-300">
                            <div class="flex items-center">
                        ...
                        <div class="group bg-teal-50 hover:bg-teal-100 p-4 rounded-lg transition-colors duration-200 border border-teal-200 hover:border-teal-300">
                            <div class="flex items-center">
                        ...
                        <div class="group bg-red-50 hover:bg-red-100 p-4 rounded-lg transition-colors duration-200 border border-red-200 hover:border-red-300">
                            <div class="flex items-center">
