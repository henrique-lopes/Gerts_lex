    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route("tenant.appointments.store") }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="type" id="type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old("type") }}" required>
                            @error("type")
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
