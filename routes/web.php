...
<<<<<<< HEAD
    ...
    Route::post('/payment/credit-card', [PaymentController::class, 'processCreditCardPayment'])->name('payment.credit_card');
    Route::post('/payment/debit-card', [PaymentController::class, 'processDebitCardPayment'])->name('payment.debit_card');
